    ...
    def extract_skills_with_importance(self, jd_text: str) -> Tuple[List[Dict], Dict[str, str]]:
        ...
        for skill in self.skills_cache:
            ...
            if skill_name_lower in normalized_text:
                ...
                importance = self._determine_importance(skill_name_lower, sections, normalized_text)
                
                # Calculate numeric weight (required=1.0, preferred=0.7, mentioned=0.5)
                ...
                skill_importance[skill.name] = importance
